...
public class CardService {
    ...
    public CardDTO create(CardDTO dto) throws ClassNotFoundException {
...
//        List list = restTemplate.getForObject("some_url", List.class);
        ...
        //RestTemplate orqali malumotlarni olish kerak Qo'shilayotgan karta Uzcard da bolishi kerak
...
// Faqat murojat qilgan profilni kartalarini korsatadi
